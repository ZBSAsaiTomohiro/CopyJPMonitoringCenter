...
//    var nowday = new Date();
//    var name = "KETAISYG00_" + nowday.getFullYear() + nowday.getMonth() + nowday.getDate() + nowday.getHours() + nowday.getMinutes() + nowday.getSeconds();
...
function fncKansiChange() {
    ...
    Form1.hdnJACD_From_CLI.value = "";      //2019/11/01 T.Ono add 監視改善2019
    Form1.hdnJACD_To_CLI.value = "";        //2019/11/01 T.Ono add 監視改善2019
}
