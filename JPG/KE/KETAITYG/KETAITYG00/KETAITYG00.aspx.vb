...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, _
        ...
        ''//件数チェックスクリプト
        'If hdnKensaku.Value = "KETAITCG00" Then
        '    Server.Transfer("./KETAITCG00.aspx")
        'End If
        ...
        strScript.Append(cscript1.mWriteScript( _
             MyBase.MapPath("../../../KE/KETAITYG/KETAITYG00/") & "KETAITYG00.js"))
        '<フォーカス関連関数>
    ...
    Private Sub btnSelect_ServerClick(ByVal sender As System.Object, _
        ...
        Dim KETAITYG00C As New KETAITYG00KETAITYW00.KETAITYW00
        ...
        '出力項目取得  2014/12/10 H.Hosoda add 監視改善2014 №13
