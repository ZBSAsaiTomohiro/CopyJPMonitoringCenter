...
Partial Class COGMNMSG00
    ...
    '<TODO>宣言共通仕様
    '******************************************************************************
    ' ScriptMessage　2014/01/24 T.Ono add 監視改善2013
    '******************************************************************************
    Private strMsg As New StringBuilder("")

    '<TODO>宣言共通仕様
    '******************************************************************************
    ' Render　2014/01/24 T.Ono add 監視改善2013
    '******************************************************************************
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        '2014/01/24 T.Ono add 監視改善2013 ユーザー情報を確認 ----------START
        '//------------------------------------------
        '//　認証クラスのインスタンス生成
        ...
        If bolUNKOU_FLG = False Then
            ...
            Next i
        End If
        '2014/01/24 T.Ono add 監視改善2013 ユーザー情報を確認 ----------END
        ...
        '2014/01/24 T.Ono add 監視改善2013 ログインユーザーにより、ボタンの表示・非表示を制御 ----------START
        ...
        ElseIf bolKANSHI_FLG = True Then
            ...
            If InStr(AuthC.pGROUPNAME, "0監視業務単独") > 0 Then
                '沖縄
                strMsg.Append("fncDispMNMS(1);")
            Else
                '川口
                strMsg.Append("fncDispMNMS(0);")
            End If
        End If
        '2014/01/24 T.Ono add 監視改善2013 ログインユーザーにより、ボタンの表示・非表示を制御 ----------END
    End Sub
