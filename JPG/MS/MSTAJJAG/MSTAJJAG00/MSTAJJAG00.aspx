...
<HTML>
	<HEAD>
		...
		<% 
'***********************************************
' íSìñé“É}ÉXÉ^  ÉÅÉCÉìâÊñ 
'***********************************************
' ïœçXóöó
' 2011/04/14 T.Watabe é©ìÆFAXï°êîÉÅÅ[ÉãëóêMÇ…ëŒâûÇ∑ÇÈà◊Ç…ÅAJAòAóçíSìñé“ñàÇ…ÉÅÅ[ÉãÉAÉhÉåÉXÇê›íËÇ≈Ç´ÇÈÇÊÇ§Ç…ïœçX
' 2011/06/21 T.Watabe é©ìÆFAXÉÅÅ[ÉãëóêMÇÃÉÅÅ[ÉãÉAÉhÉåÉXç≈ëÂåÖêîÇ30åÖÇ©ÇÁ50åÖÇ…ïœçX
' 2011/11/08 H.Uema   JAñàÇÃíçà”éñçÄÇìoò^Ç≈Ç´ÇÈÇÊÇ§Ç…â¸èC
' 2011/12/01 H.Uema   FAXïsóvèâä˙ílê›íËÇÇ≈Ç´ÇÈÇÊÇ§Ç…â¸èC
' 2012/03/30 W.GANEKO ÉXÉ|ÉbÉgFAXópÉAÉhÉåÉXãyÇ— ﬂΩ‹∞ƒﬁí«â¡
' 2013/05/17 T.Ono å⁄ãqíPà Ç≈ÇÃìoò^ã@î\í«â¡		    
' 2015/11    T.ONO MSTAGJAGÇ…à⁄çsÅBìñÉvÉçÉOÉâÉÄÇÕñ¢égóp
%>
		<!-- Å•Å•Å• 2011/11/08 H.Uema ADD É^ÉuëŒâû Å•Å•Å• -->
		<style type="text/css">
	...
	<body>
		<form id="Form1" method="post" runat="server" enctype="multipart/form-data">
			...
			<table cellSpacing="0" cellPadding="0" width="100%">
						...
						<table cellSpacing="2" cellPadding="0" width="900">
							<tr>
								...
								<td align="right" width="80"><input class="bt-JIK" id="btnExit" onblur="fncFo(this,5)" onfocus="fncFo(this,2)" onclick="return btnExit_onclick();"
										tabIndex="1006" type="button" value="èIóπ" name="btnExit" runat="server">
								</td>
							</tr>
						</table>
					</td>
				...
				<tr>
					<td vAlign="bottom">
							...
							<tr>
								...
								<td vAlign="middle" width="710">
									<table cellSpacing="0" cellPadding="2" width="100%">
										<tr>
											<%-- <td class="TITLE" vAlign="middle">JAíSìñé“É}ÉXÉ^</td> 2015/02/17 T.Ono mod 2014â¸ëPäJî≠ No15--%>
											<td class="TITLE" vAlign="middle">JAíSìñé“ÅEïÒçêêÊÉ}ÉXÉ^</td>
										</tr>
									</table>
								</td>
								<td vAlign="middle" align="right" width="170">çÏê¨ì˙ÅF<asp:textbox id="txtAYMD" tabIndex="-1" runat="server" CssClass="c-RO" Width="72px" BorderStyle="Solid"
										BorderWidth="1px"></asp:textbox><br>
									çXêVì˙ÅF<asp:textbox id="txtUYMD" tabIndex="-1" runat="server" CssClass="c-RO" Width="72px" BorderStyle="Solid"
						...
						<!-- Å•Å•Å• 2010/04/12 T.Watabe add Å•Å•Å• -->
			...
			<hr>
			<!-- Å•Å•Å• 2013/05/22 T.Ono add å⁄ãqíPà ìoò^ã@î\í«â¡ Å•Å•Å• -->
            <!-- <table cellSpacing="1" cellPadding="5" width="980"> -->
            <table cellSpacing="1" cellPadding="5" width="1150">
				<tr>
					<td width="10">&nbsp;</td>
					<td width="100" class="TXTKY" align="right">ÉNÉâÉCÉAÉìÉgÉRÅ[Éh&nbsp;&nbsp;</td>
					...
					<%--<td width="350"><asp:textbox id="txtKURACD" tabIndex="-1" runat="server" CssClass="c-rNM" Width="250px" BorderStyle="Solid"
							...
							tabIndex="2" type="button" value="Å•" name="btnKURACD" runat="server"> <INPUT id="hdnKURACD" type="hidden" name="hdnKURACD" runat="server">
                    ...
                    <td width="350"><asp:textbox id="txtKURACD" tabIndex="-1" runat="server" CssClass="c-rNM" Width="250px" BorderStyle="Solid"
							...
							tabIndex="1" type="button" value="Å•" name="btnKURACD" runat="server"> <INPUT id="hdnKURACD" type="hidden" name="hdnKURACD" runat="server">
						<INPUT id="hdnKURACD_MOTO" type="hidden" name="hdnKURACD_MOTO" runat="server">
					</td>
					<td colspan="2" rowspan="3" class="style1">
						<div style="BORDER-RIGHT:black 1px dotted; BORDER-TOP:black 1px dotted; Z-INDEX:1; BORDER-LEFT:black 1px dotted; WIDTH:350px; BORDER-BOTTOM:black 1px dotted; BACKGROUND-COLOR:#edffdb">
							...
							<div>
								ÉtÉ@ÉCÉãìoò^ <INPUT type="file" ID="FileUpload1" name="FileUpload1" width="60px">
							...
							<asp:textbox id="txtFileName1" tabIndex="-1" runat="server" CssClass="c-rNM" Width="250px" BorderStyle="Solid"
								BorderWidth="1px" ReadOnly="True"></asp:textbox><asp:button ID="btnFileDownload1" runat="server" text="äJÇ≠" /><asp:button ID="btnFileDelete1" runat="server" text="çÌèú" /><br>
							<asp:textbox id="txtFileName2" tabIndex="-1" runat="server" CssClass="c-rNM" Width="250px" BorderStyle="Solid"
								BorderWidth="1px" ReadOnly="True"></asp:textbox><asp:button ID="btnFileDownload2" runat="server" text="äJÇ≠" /><asp:button ID="btnFileDelete2" runat="server" text="çÌèú" />--%>
                            <asp:textbox id="hdnFileKey" Visible="False" runat="server"></asp:textbox>
							<asp:textbox id="txtFileName1" tabIndex="-1" runat="server" CssClass="c-rNM" Width="250px" BorderStyle="Solid"
								BorderWidth="1px"></asp:textbox><asp:button ID="btnFileDownload1" runat="server" text="äJÇ≠" /><asp:button ID="btnFileDelete1" runat="server" text="çÌèú" /><br>
							<asp:textbox id="txtFileName2" tabIndex="-1" runat="server" CssClass="c-rNM" Width="250px" BorderStyle="Solid"
								BorderWidth="1px"></asp:textbox><asp:button ID="btnFileDownload2" runat="server" text="äJÇ≠" /><asp:button ID="btnFileDelete2" runat="server" text="çÌèú" />
							<!-- /form -->
						</div>
					</td>
                <!-- Å•Å•Å• 2013/05/17 T.Ono add å⁄ãqíPà ìoò^ã@î\í«â¡ Å•Å•Å• -->
					<!-- Å•Å•Å• 2011/12/01 H.Uema ADD FAXïsóvèâä˙ílê›íËÉâÉWÉIÉ{É^Éìí«â¡ Å•Å•Å• -->
					<td rowspan="3">
						<%-- 2013/12/13 T.Ono mod äƒéãâ¸ëP2013Å@idí«â¡
                        <table cellSpacing="1" cellPadding="1" class="W"> --%>
                        <table id="tblFAX_Default" cellSpacing="1" cellPadding="1" class="W">
							<tr>
                                <%-- 2013/11/28 T.Ono mod äƒéãâ¸ëP2013 --%>
								<%-- <td colspan="2">Åi FAXïsóvèâä˙íl Åj</td> --%>
								<td colspan="3">Åi ïÒçêóvÅEïsóvèâä˙íl Åj</td>
							</tr>
							<tr>
								...
								<%-- 2013/11/28 T.Ono mod äƒéãâ¸ëP2013 --%>
                                <%-- <td vAlign="middle"><label for="rdoFAXJA1">ñ¢ê›íË&nbsp;&nbsp;&nbsp;&nbsp;</label></td> --%>
                                <td vAlign="middle"><label for="rdoFAXJA1">è„à ê›íËéQè∆&nbsp;</label></td>
								...
								<td vAlign="middle"><label for="rdoFAXJA2">ïKóv&nbsp;&nbsp;&nbsp;&nbsp;</label></td>
								...
								<td vAlign="middle"><label for="rdoFAXJA3">ïsóv&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                <input id="hdnFAXJA_MOTO" type="hidden" name="hdnFAXJA_MOTO" value="9" runat="server"/><!-- 2015/02/18 T.Ono add 2014â¸ëPäJî≠ No15 -->
                                </td>
							</tr>
							<tr>
								<td align="right">∏◊≤±›ƒ&nbsp;&nbsp;</td>
								...
								<%-- 2013/11/28 T.Ono mod äƒéãâ¸ëP2013 --%>
                                <%-- <td vAlign="middle"><label for="rdoFAXKURA1">ñ¢ê›íË&nbsp;&nbsp;&nbsp;&nbsp;</label></td> --%>
                                <td vAlign="middle"><label for="rdoFAXKURA1">è„à ê›íËéQè∆&nbsp;</label></td>
								...
								<td vAlign="middle"><label for="rdoFAXKURA2">ïKóv&nbsp;&nbsp;&nbsp;&nbsp;</label></td>
								...
								<td vAlign="middle"><label for="rdoFAXKURA3">ïsóv&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                <input id="hdnFAXKURA_MOTO" type="hidden" name="hdnFAXKURA_MOTO" value="9" runat="server"/><!-- 2015/02/18 T.Ono add 2014â¸ëPäJî≠ No15 -->
                                </td>
							</tr>
						</table>
					</td>
				...
				<tr>
					<td>&nbsp;</td>
					<td class="TXTKY" align="right">ÇiÇ`éxèäÉRÅ[Éh&nbsp;&nbsp;</td>
                    <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
					<%--<td><asp:textbox id="txtCODE" tabIndex="-1" runat="server" CssClass="c-rNM" Width="300px" BorderStyle="Solid"
							...
							tabIndex="3" type="button" value="Å•" name="btnCODECD" runat="server"> <INPUT id="hdnCODE" type="hidden" name="hdnCODE" runat="server">
                    ...
                    <td><asp:textbox id="txtCODE" tabIndex="-1" runat="server" CssClass="c-rNM" Width="300px" BorderStyle="Solid"
							...
							tabIndex="2" type="button" value="Å•" name="btnCODECD" runat="server"> <INPUT id="hdnCODE" type="hidden" name="hdnCODE" runat="server">
						<INPUT id="hdnCODE_MOTO" type="hidden" name="hdnCODE_MOTO" runat="server">
					</td>
				</tr>
                <!-- Å•Å•Å• 2013/05/17 T.Ono add å⁄ãqíPà ìoò^ã@î\í«â¡ Å•Å•Å• -->
    			<tr>
					<td></td>
					<td class="TXTKY" align="right" >Ç®ãqólÉRÅ[Éh&nbsp;&nbsp;</td>
                    <td>
                        ...
                        <input id="hdnUSER_CD_TEMP" type="hidden" name="hdnUSER_CD_TEMP" runat="server"> <!-- ŒﬂØÃﬂ±ØÃﬂÇ©ÇÁÇÃñﬂÇËílàÍéûï€ä«óp 2015/02/18 T.Ono add 2014â¸ëPäJî≠ No15 -->
					</td>
				</tr>
				<tr>
					<td></td>
					<td align="right">Ç®ãqóléÅñº&nbsp;&nbsp;</td>
                    <td>
                    ...
                    <td colspan="3" align="right"><span id="spS1"><a href="MSTAJJAG00_K.pdf" tabIndex="6" target="_blank"><img src="../../../Script/icon_pdf.gif" border="0">É}ÉjÉÖÉAÉã&nbsp;&nbsp;</a></span>
                    <span id="spS2"><a href="MSTAJJAG00_O.pdf" tabIndex="6" target="_blank"><img src="../../../Script/icon_pdf.gif" border="0">É}ÉjÉÖÉAÉã&nbsp;&nbsp;</a></span></td>
				</tr>
                <%-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 START --%>
                <tr>
                    <td></td>
					<td align="right">ìoò^çœÇ›ëIë&nbsp;&nbsp;</td>
                    <td><input class="bt-RNW" id="btnTOUROKUZUMI" onblur="fncFo(this,5)" onfocus="fncFo(this,2)" onclick="return btnPopup_onclick('3');"
							tabindex="4" type="button" value="ìoò^çœÇ›àÍóó" name="btnTOUROKUZUMI" runat="server"/></td>
                    <td></td>                
                </tr>         
                <%-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 END --%>
                <%--2013/05/17 T.Ono del FAXïsóvèâä˙ílê›íËÉâÉWÉIÉ{É^Éìà⁄ìÆÅ@            
				<tr>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<!-- Å•Å•Å• 2011/12/01 H.Uema ADD FAXïsóvèâä˙ílê›íËÉâÉWÉIÉ{É^Éìí«â¡ Å•Å•Å• -->
					<td>
						<table cellSpacing="1" cellPadding="1" class="W">
							...
							<tr>
								...
								<td vAlign="middle"><label for="rdoFAXJA3">ïsóv&nbsp;&nbsp;&nbsp;&nbsp;</label></td>
							</tr>
							<tr>
								<td align="right">∏◊≤±›ƒ&nbsp;&nbsp;</td>
								<td vAlign="middle"><input id="rdoFAXKURA1" onkeydown="fncFc(this)" onblur="fncFo(this,4)" onfocus="fncFo(this,2)"
								...
								<td vAlign="middle"><input id="rdoFAXKURA3" onkeydown="fncFc(this)" onblur="fncFo(this,4)" onfocus="fncFo(this,2)"
										tabIndex="5" type="radio" value="3" name="rdoFAXKURA" runat="server"></td>
								<td vAlign="middle"><label for="rdoFAXKURA3">ïsóv&nbsp;&nbsp;&nbsp;&nbsp;</label></td>
							</tr>
						</table>
					</td>
					<!-- Å£Å£Å£ 2011/12/01 H.Uema ADD FAXïsóvèâä˙ílê›íËÉâÉWÉIÉ{É^Éìí«â¡ Å£Å£Å£ -->
            ...
            <ul id="tab">
				<li class="present">
					<a href="#page1">àÍóó</a></li>
				<li>
					<!-- <a href="#page2">JAíçà”éñçÄ</a></li> -->
                    <!-- <a href="#page2"><INPUT id="txtPageNM2" type="text" name="txtPageNM2" value="JAíçà”éñçÄ" runat="server"></a></li> -->
                    <!--Å@<a href="#page2" ><asp:label id="lblPageNM2" Runat="server" Text="JAíçà”éñçÄ"></asp:label></a></li> 2013/07/26 T.Ono mof -->
                    <a href="#page2" ><asp:label id="Label1" Runat="server" Text="íçà”éñçÄ"></asp:label></a></li>
			</ul>
			<!-- Å£Å£Å£ 2011/11/08 H.Uema ADD É^ÉuëŒâû Å£Å£Å£ -->
			<div id="page1">
                <!-- Å•Å•Å• 2013/05/22 T.Ono add å⁄ãqíPà ìoò^ã@î\í«â¡ Å•Å•Å• -->
                <div id="hyoji">
                    <table>
                        <tr>
                            <%-- <td Width="630px"></td> 2015/02/17 T.Ono mod 2014â¸ëPäJî≠ No15 START --%>
                            <td width="630px"><input class="bt-RNW" id="btnICHIRAN_COPY" onblur="fncFo(this,5)" onfocus="fncFo(this,2)" onclick="fncIchiran_Copy()"
							    tabindex="7" type="button" value="ÉRÉsÅ[" name="btnICHIRAN_COPY" runat="server"/>
                                <input class="bt-RNW" id="btnICHIRAN_PASTE" onblur="fncFo(this,5)" onfocus="fncFo(this,2)" onclick="fncIchiran_Paste()"
							    tabindex="8" type="button" value="ÉyÅ[ÉXÉg" name="btnICHIRAN_PASTE" runat="server"/>
                                <input class="bt-RNW" id="btnICHIRAN_CLEAR" onblur="fncFo(this,5)" onfocus="fncFo(this,2)" onclick="fncIchiran_Clear()"
							    tabindex="9" type="button" value="ÉNÉäÉA" name="btnICHIRAN_CLEAR" runat="server"/></td>
                            <%-- 2015/02/17 T.Ono mod 2014â¸ëPäJî≠ No15 END --%>
                            <td>
                                <table cellSpacing="1" cellPadding="1" class="W">
							        <tr>
                                        <td vAlign="middle"><label for="rdoHYOJI1">FAXì¸óÕëIëÅF&nbsp;&nbsp;&nbsp;&nbsp;</label></td>
								        ...
								        <td vAlign="middle"><label for="rdoHYOJI1">ÉXÉ|ÉbÉgFAX&nbsp;&nbsp;&nbsp;&nbsp;</label></td>
								        ...
								        <td vAlign="middle"><label for="rdoHYOJI2">é©ìÆFAX&nbsp;&nbsp;&nbsp;&nbsp;</label></td>
							        </tr>
                                </table>
                            </td>
                        </tr>
				...
				<table cellSpacing="0" cellPadding="0">
                    <!-- Å•Å•Å• 2013/05/22 T.Ono mod å⁄ãqíPà ìoò^ã@î\í«â¡ tr/tdÇ÷idïtó^ Å•Å•Å• -->
					<tr id="koumoku">
						<td id="DispAlwy_100" align="left" height="25">∫ÀﬂÕﬂ </td> <!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
						<td id="DispAlwy_1" align="left" height="25">∫∞ƒﬁ</td>
                        <!-- <td id="DispAlwy_2" align="left" height="25">íSìñé“ñºäøéö</td> 2013/07/26 T.Ono mod å⁄ãqíPà ìoò^ã@î\í«â¡ -->
						<td id="DispAlwy_2" align="left" height="25">&nbsp;&nbsp;íSìñé“ñºäøéö</td>
						<td id="DispSpot_1" align="left" height="25">ìdòbî‘çÜÇP</td>
						<td id="DispSpot_2" align="left" height="25">ìdòbî‘çÜÇQ</td>
						<td id="DispSpot_3" align="left" height="25">ìdòbî‘çÜÇR</td>             <!-- 2013/05/22 T.Ono add å⁄ãqíPà ìoò^ã@î\í«â¡ -->
						<!-- <td id="DispSpot_4" align="left" height="25">FAXî‘çÜ</td> 2013/07/26 T.Ono mod å⁄ãqíPà ìoò^ã@î\í«â¡ -->
                        <td id="DispSpot_4" align="left" height="25">ΩŒﬂØƒFAXî‘çÜ</td>
						<!-- <td id="DispSpot_5" align="left" height="25">îıçl(Å¶àÛç¸ëŒè€äO)</td> 2013/11/28 T.Ono mod äƒéãâ¸ëP2013 -->
						<td id="DispSpot_5" align="left" height="25">ãLéñ(Å¶àÛç¸ëŒè€äO)</td>
						<!-- <td align="left" height="25">é©ìÆFAXëóêMêÊ“∞Ÿ±ƒﬁ⁄Ω</td>              2013/05/23 T.Ono del å⁄ãqíPà ìoò^ã@î\í«â¡ -->
						<td id="DispSpot_6" align="left" height="25">ΩŒﬂØƒFAXëóêMêÊ“∞Ÿ±ƒﬁ⁄Ω</td>
						<td id="DispSpot_7" align="left" height="25" width="100px">ΩŒﬂØƒFAXìYïtÃß≤Ÿ ﬂΩ‹∞ƒﬁ</td>
                        <!-- Å•Å•Å• 2013/05/22 T.Ono add å⁄ãqíPà ìoò^ã@î\í«â¡ Å•Å•Å• -->
                        <td id="DispAUTO_186" align="left" height="25">é©ìÆFAXëóêMñº</td>
                        <td id="DispAUTO_1" align="left" height="25">é©ìÆFAXëóêMêÊ“∞Ÿ±ƒﬁ⁄Ω</td>
                        <td id="DispAUTO_2" align="left" height="25" width="100px">é©ìÆFAXìYïtÃß≤Ÿ ﬂΩ‹∞ƒﬁ</td>
                        <td id="DispAUTO_3" align="left" height="25">é©ìÆFAXî‘çÜ</td>
                        <td id="DispAUTO_4" align="left" height="25">é©ìÆëóêMãÊï™</td>
                        <td id="DispAUTO_5" align="left" height="25">É[ÉçåèëóêMÉtÉâÉO</td>
                        <!-- Å£Å£Å£ 2013/05/22 T.Ono add å⁄ãqíPà ìoò^ã@î\í«â¡ Å£Å£Å£ -->
					</tr>
					<tr id="list_1">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_101"><asp:checkbox id="chkCopy_1" tabIndex="11" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
                        ...
                        <!-- Å•Å•Å• 2013/05/23 T.Ono add å⁄ãqíPà ìoò^ã@î\í«â¡ Å•Å•Å• -->
					...
					<tr id="list_2">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_102"><asp:checkbox id="chkCopy_2" tabIndex="31" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<tr id="list_3">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_103"><asp:checkbox id="chkCopy_3" tabIndex="51" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<tr id="list_4">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_104"><asp:checkbox id="chkCopy_4" tabIndex="71" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<tr id="list_5">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_105"><asp:checkbox id="chkCopy_5" tabIndex="91" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<tr id="list_6">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_106"><asp:checkbox id="chkCopy_6" tabIndex="111" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<tr id="list_7">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_107"><asp:checkbox id="chkCopy_7" tabIndex="131" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<tr id="list_8">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_108"><asp:checkbox id="chkCopy_8" tabIndex="151" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<tr id="list_9">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_109"><asp:checkbox id="chkCopy_9" tabIndex="171" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<tr id="list_10">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_110"><asp:checkbox id="chkCopy_10" tabIndex="191" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<tr id="list_11">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_111"><asp:checkbox id="chkCopy_11" tabIndex="211" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<tr id="list_12">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_112"><asp:checkbox id="chkCopy_12" tabIndex="231" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<tr id="list_13">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_113"><asp:checkbox id="chkCopy_13" tabIndex="251" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<tr id="list_14">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_114"><asp:checkbox id="chkCopy_14" tabIndex="271" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<tr id="list_15">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_115"><asp:checkbox id="chkCopy_15" tabIndex="291" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
                        ...
                        <!-- Å•Å•Å• 2013/05/23 T.Ono del å⁄ãqíPà ìoò^ã@î\í«â¡ Å•Å•Å• -->
					...
					<tr id="list_16">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_116"><asp:checkbox id="chkCopy_16" tabIndex="311" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<tr id="list_17">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_117"><asp:checkbox id="chkCopy_17" tabIndex="331" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<tr id="list_18">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_118"><asp:checkbox id="chkCopy_18" tabIndex="351" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<tr id="list_19">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_119"><asp:checkbox id="chkCopy_19" tabIndex="371" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<tr id="list_20">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_120"><asp:checkbox id="chkCopy_20" tabIndex="391" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<tr>
						<td colspan="6">Å´21Å`30ÇÕàÛç¸ëŒè€äOÅ´</td>
					</tr>
					<tr id="list_21">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_121"><asp:checkbox id="chkCopy_21" tabIndex="411" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<tr id="list_22">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_122"><asp:checkbox id="chkCopy_22" tabIndex="451" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<tr id="list_23">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_123"><asp:checkbox id="chkCopy_23" tabIndex="471" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<tr id="list_24">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_124"><asp:checkbox id="chkCopy_24" tabIndex="491" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<tr id="list_25">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_125"><asp:checkbox id="chkCopy_25" tabIndex="511" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<tr id="list_26">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_126"><asp:checkbox id="chkCopy_26" tabIndex="531" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<tr id="list_27">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_127"><asp:checkbox id="chkCopy_27" tabIndex="551" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<tr id="list_28">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_128"><asp:checkbox id="chkCopy_28" tabIndex="571" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<tr id="list_29">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_129"><asp:checkbox id="chkCopy_29" tabIndex="591" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<tr id="list_30">
                        <%--2012/04/04 .NET égópïœçXÇ…ÇÊÇËÅAReadOnlyÇÕVBë§Ç≈AttributeÇ≈Ç¬ÇØÇÈ--%>
                        <td id="DispAlwy_130"><asp:checkbox id="chkCopy_30" tabIndex="611" runat="server" Width="32px" onkeydown="fncFc(this)" /></td><!-- 2015/02/17 T.Ono add 2014â¸ëPäJî≠ No15 -->
					...
					<!-- Å£Å£Å£ 2010/04/12 T.Watabe add Å£Å£Å£ -->
                    <!-- Å£Å£Å£ 2013/05/22 T.Ono mod å⁄ãqíPà ìoò^ã@î\í«â¡ Å£Å£Å£ -->
				</table>
			</div>
			<!-- Å•Å•Å• 2011/11/08 H.Uema add íçà”éñçÄìoò^ÉtÉHÅ[ÉÄçÏê¨ Å•Å•Å• -->
			<div id="page2">
				<table>
					<tr valign="top">
						<td align="right" class="style2">
							<%-- 2013/0627 T.Ono mod 
                            <b>JAíçà”éñçÄ</b><br> --%>
                            <b><asp:label id="lblpre" style="font-size:10pt" Runat="server" Text="JAíçà”éñçÄ"></asp:label></b><br>
							<br>
                            ...
                            <!-- 2013/06/19 mod T.Ono START -->
							 <input style="BACKGROUND-COLOR:buttonface" id="preview" onblur="fncFo(this,5)" onfocus="fncFo(this,2)"
								onclick="hpre(txtGUIDELINE);" tabIndex="309" type="button" value="ÉvÉåÉrÉÖÅ[" name="preview"
								runat="server"> 
        <%--                    <input style="BACKGROUND-COLOR:buttonface" id="preview" onblur="fncFo(this,5)" onfocus="fncFo(this,2)"
								onclick="hpre(txtGUIDELINE,lblpre);" tabIndex="309" type="button" value="ÉvÉåÉrÉÖÅ[" name="preview"
								runat="server">--%>
                        ...
                        <%-- <td nowrap width="200" height="400"> 
                                <span id="pre" class="preview">&nbsp;<!-- ÉvÉåÉrÉÖÅ[óÃàÊ --></span>--%>
                        <td nowrap width="400" height="420">
							<asp:label id="pre" class="preview" width="400" height="420" Runat="server"></asp:label><!-- ÉvÉåÉrÉÖÅ[óÃàÊ -->
						</td>
					</tr>
				</table>
			</div>
		...
		<!-- Å•Å•Å• 2011/11/08 H.Uema add É^Éuêÿë÷ópïœêîÇÃê›íË Å•Å•Å• -->
