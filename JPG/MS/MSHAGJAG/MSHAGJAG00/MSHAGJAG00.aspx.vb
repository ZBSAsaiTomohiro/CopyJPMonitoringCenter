...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strScript.Append(cscript1.mWriteScript( _
             MyBase.MapPath("../../../MS/MSHAGJAG/MSHAGJAG00/") & "MSHAGJAG00.js"))
        '<フォーカス関連関数>
    ...
    Private Sub fncIni_notkey()
        ...
        Dim objHANJIGYOSYANM As System.Web.UI.WebControls.TextBox
        ...
        For i = 1 To 100
            ...
            objHANJIGYOSYANM = CType(FindControl("txtHANJIGYOSYANM_" & CStr(i)), System.Web.UI.WebControls.TextBox)
        ...
        Try
            ...
            Else
                ...
                For intRow = 0 To dbData.Tables(0).Rows.Count - 1
                    ...
                    objHANJIGYOSYANM = CType(FindControl("txtHANJIGYOSYANM_" & CStr(intRow + 1)), System.Web.UI.WebControls.TextBox)
                    ...
                    objHANJIGYOSYANM.Text = Convert.ToString(dbData.Tables(0).Rows(intRow).Item("HANJIGYOSYANM"))
    ...
    Private Function fncbtnJikkou_ClickEvent(ByVal pstrKBN As String) As String
        ...
        Dim MSHAGJAW00C As New MSHAGJAG00MSHAGJAW00.MSHAGJAW00
        ...
        Dim sHANJIGYOSYANM(100) As String
        ...
        For i = 1 To 100
            ...
            sHANJIGYOSYANM(i) = objHANJIGYOSYANM.Text.Trim
    ...
    Private Function fncDataSelect() As DataSet
        ...
        '//------------------------------------------
        '//<TODO>Select文の作成
        Dim SQLC As New MSHAGJAG00CCSQL.CSQL
    ...
    Private Sub btnCSVOUT_ServerClick(ByVal sender As System.Object, _
        ...
        Dim strRec As String
        Dim MSHAGJAG00C As New MSHAGJAG00MSHAGJAW00.MSHAGJAW00
        ...
        Else
            ...
            HttpHeaderC.mDownLoadCSV(Response, "販売事業者グループマスタ.csv")
