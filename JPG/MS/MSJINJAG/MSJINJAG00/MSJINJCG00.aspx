<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MSJINJCG00.aspx.vb" Inherits="MSJINJAG00.MSJINJCG00" EnableSessionState="ReadOnly" enableViewState="False" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
  		<META http-equiv="Content-Type" content="text/html; charset=shift_jis">
		<title>MSJINJCG00</title>
		<script language="JavaScript">
			window.resizeTo(420,430);
			function window_open() {
				fncListOut("MSJINJBG00","ifList1");
			}
		</script>
	</HEAD>
