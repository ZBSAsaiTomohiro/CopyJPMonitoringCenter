<%@ Page Language="vb" AutoEventWireup="false" Codebehind="COPOPUFG00.aspx.vb" Inherits="JPG.COPOPUFG00" EnableSessionState="ReadOnly" enableViewState="False"%>
...
onclick="fncPutData('<%# DataBinder.Eval(Container,"DataItem.CODE") %>','<%# DataBinder.Eval(Container,"DataItem.CDNM") %>','<%# DataBinder.Eval(Container,"DataItem.CODE2") %>','<%# DataBinder.Eval(Container,"DataItem.CDNM2") %>')" 
<%-- 2014/11/04 Hosoda mod ポップアップ表示幅変更 START --%>
