...
<System.Web.Services.WebService(Namespace:="http://tempuri.org/MSHATJAW00/Service1")> _
Public Class MSHATJAW00
...
#End Region
    ...
    <WebMethod()> Public Function mSetEx(
                                    ...
                                    ByVal pstrTARGET() As String,
                                    ByVal pstrGROUPCD() As String,
                                    ByVal pstrGROUPNM() As String,
                                    ByVal pstrHANBAITENNM() As String,
    ...
    '販売店グループマスタ更新
    '************************************************
    <WebMethod()> Public Function mSetMASTER(
                                ByRef cdb As CDB,
                                ByVal pintMODE As Integer,
                                ByVal pstrTARGET As String,
                                ByVal pstrGROUPCD As String,
        ...
        Try
            ...
            If (pintMODE = 2) Then 'ＤＢにデータが存在して、更新の場合
                ...
                If (
                        ...
                        (Convert.ToString(ds.Tables(0).Rows(0).Item("HANBAITENNM")) = pstrHANBAITENNM) And
            ...
            ElseIf pintMODE = 2 Then
                ...
                strSQL.Append("    	HANBAITENNM = :HANBAITENNM, ")
            ...
            ElseIf pintMODE = 1 Or pintMODE = 2 Then
                ...
                cdb.pSQLParamStr("HANBAITENNM") = pstrHANBAITENNM
