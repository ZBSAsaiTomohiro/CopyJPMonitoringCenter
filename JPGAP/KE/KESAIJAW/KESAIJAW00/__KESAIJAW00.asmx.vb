...
<System.Web.Services.WebService(Namespace:="http://tempuri.org/KESAIJAW00/Service1")>
...
#End Region
    ...
    <WebMethod()> Public Function mExcel(
        ...
        Try
            ...
            ExcelC.pRepoID = "KESAIJAW00"       '帳票ID
    ...
    Function excelOut1(ByVal ds As DataSet, ByVal dr As DataRow, ByVal ExcelC As Common.CExcel) As Common.CExcel
        ...
        ExcelC.pCellStyle(1) = excel_h56px & excel_w35px & excel_backgroundcolor
        ExcelC.pCellStyle(2) = excel_h56px & excel_w35px & excel_backgroundcolor
        ExcelC.pCellStyle(3) = excel_h56px & excel_w35px & excel_backgroundcolor
        ...
        ExcelC.pCellStyle(7) = excel_h56px & excel_w65px & excel_backgroundcolor
        ExcelC.pCellStyle(8) = excel_h56px & excel_w40px & excel_backgroundcolor
        ExcelC.pCellStyle(9) = excel_h56px & excel_w40px & excel_backgroundcolor
        ExcelC.pCellStyle(10) = excel_h56px & excel_w30px & excel_backgroundcolor
        ExcelC.pCellStyle(11) = excel_h56px & excel_w150px & excel_backgroundcolor
        ExcelC.pCellStyle(12) = excel_h56px & excel_w100px & excel_backgroundcolor
        ExcelC.pCellStyle(13) = excel_h56px & excel_w100px & excel_backgroundcolor
        ExcelC.pCellStyle(14) = excel_h56px & excel_w40px & excel_backgroundcolor
        ExcelC.pCellStyle(15) = excel_h56px & excel_w40px & excel_backgroundcolor
        ExcelC.pCellStyle(16) = excel_h56px & excel_w40px & excel_backgroundcolor
        ...
        ExcelC.pCellStyle(19) = excel_h56px & excel_w50px & excel_backgroundcolor
        ExcelC.pCellStyle(20) = excel_h56px & excel_w50px & excel_backgroundcolor
        ExcelC.pCellStyle(21) = excel_h56px & excel_w50px & excel_backgroundcolor
        ...
        ExcelC.pCellStyle(25) = excel_h56px & excel_w50px & excel_backgroundcolor
        ExcelC.pCellStyle(26) = excel_h56px & excel_w60px & excel_backgroundcolor
        ExcelC.pCellStyle(27) = excel_h56px & excel_w100px & excel_backgroundcolor
        ExcelC.pCellStyle(28) = excel_h56px & excel_w60px & excel_backgroundcolor
        ExcelC.pCellStyle(29) = excel_h56px & excel_w100px & excel_backgroundcolor
        ExcelC.pCellStyle(30) = excel_h56px & excel_w60px & excel_backgroundcolor
        ExcelC.pCellStyle(31) = excel_h56px & excel_w100px & excel_backgroundcolor
        ExcelC.pCellStyle(32) = excel_h56px & excel_w100px & excel_backgroundcolor
        ExcelC.pCellStyle(33) = excel_h56px & excel_w100px & excel_backgroundcolor
        ExcelC.pCellStyle(34) = excel_h56px & excel_w100px & excel_backgroundcolor
        ExcelC.pCellStyle(35) = excel_h56px & excel_w100px & excel_backgroundcolor
        ExcelC.pCellStyle(36) = excel_h56px & excel_w70px & excel_backgroundcolor

        ExcelC.pCellStyle(37) = excel_h56px & excel_w70px & excel_backgroundcolor
        ExcelC.pCellStyle(38) = excel_h56px & excel_w70px & excel_backgroundcolor
        ExcelC.pCellStyle(39) = excel_h56px & excel_w100px & excel_backgroundcolor
        ExcelC.pCellStyle(40) = excel_h56px & excel_w70px & excel_backgroundcolor
        ExcelC.pCellStyle(41) = excel_h56px & excel_w70px & excel_backgroundcolor
        ExcelC.pCellStyle(42) = excel_h56px & excel_w70px & excel_backgroundcolor
        ExcelC.pCellStyle(43) = excel_h56px & excel_w150px & excel_backgroundcolor
        ExcelC.pCellStyle(44) = excel_h56px & excel_w100px & excel_backgroundcolor
        ExcelC.pCellStyle(45) = excel_h56px & excel_w70px & excel_backgroundcolor
        ExcelC.pCellStyle(46) = excel_h56px & excel_w70px & excel_backgroundcolor
        ExcelC.pCellStyle(47) = excel_h56px & excel_w100px & excel_backgroundcolor
        ExcelC.pCellStyle(48) = excel_h56px & excel_w30px & excel_backgroundcolor
        ExcelC.pCellStyle(49) = excel_h56px & excel_w50px & excel_backgroundcolor
        ExcelC.pCellStyle(50) = excel_h56px & excel_w60px & excel_backgroundcolor
        ExcelC.pCellStyle(51) = excel_h56px & excel_w60px & excel_backgroundcolor
        ExcelC.pCellStyle(52) = excel_h56px & excel_w60px & excel_backgroundcolor
        ExcelC.pCellStyle(53) = excel_h56px & excel_w60px & excel_backgroundcolor
        ExcelC.pCellStyle(54) = excel_h56px & excel_w100px & excel_backgroundcolor

        ExcelC.pCellStyle(55) = excel_h56px & excel_w100px & excel_backgroundcolor
        ExcelC.pCellStyle(56) = excel_h56px & excel_w100px & excel_backgroundcolor
        ExcelC.pCellStyle(57) = excel_h56px & excel_w60px & excel_backgroundcolor
        ExcelC.pCellStyle(58) = excel_h56px & excel_w60px & excel_backgroundcolor
        ExcelC.pCellStyle(59) = excel_h56px & excel_w60px & excel_backgroundcolor
        ExcelC.pCellStyle(60) = excel_h56px & excel_w60px & excel_backgroundcolor
        ExcelC.pCellStyle(61) = excel_h56px & excel_w100px & excel_backgroundcolor
        ExcelC.pCellStyle(62) = excel_h56px & excel_w100px & excel_backgroundcolor
        ExcelC.pCellStyle(63) = excel_h56px & excel_w60px & excel_backgroundcolor
        ExcelC.pCellStyle(64) = excel_h56px & excel_w60px & excel_backgroundcolor
        ExcelC.pCellStyle(65) = excel_h56px & excel_w70px & excel_backgroundcolor
        ExcelC.pCellStyle(66) = excel_h56px & excel_w70px & excel_backgroundcolor
        ExcelC.pCellStyle(67) = excel_h56px & excel_w70px & excel_backgroundcolor
        ExcelC.pCellStyle(68) = excel_h56px & excel_w10px & excel_backgroundcolor

        i = 1

        ExcelC.pCellVal(i) = Convert.ToString("FAXJA報告") : i += 1 '2017/02/17 W.GANEKO MOD 2016監視改善 №7 1
        ExcelC.pCellVal(i) = Convert.ToString("FAXｸﾗ報告") : i += 1 '2017/02/17 W.GANEKO MOD 2016監視改善 №7 2
        ExcelC.pCellVal(i) = Convert.ToString("累積報告") : i += 1  '2017/02/17 W.GANEKO MOD 2016監視改善 №7 3
        ExcelC.pCellVal(i) = Convert.ToString("依頼書") : i += 1    '2017/02/17 W.GANEKO MOD 2016監視改善 №7 4
        ExcelC.pCellVal(i) = Convert.ToString("発生月日") : i += 1 ' 2013/08/27 T.Ono add 監視改善2013№8     5
        ExcelC.pCellVal(i) = Convert.ToString("発生時刻") : i += 1 ' 2013/08/27 T.Ono add 監視改善2013№8     6
        ExcelC.pCellVal(i) = Convert.ToString("受信日") : i += 1                                             '7
        ExcelC.pCellVal(i) = Convert.ToString("受信時刻") : i += 1                                           '8
        ...
        ExcelC.pCellVal(i) = Convert.ToString("販売事業者コード") : i += 1     ' 2014/12/11 H.Hosoda add 監視改善2014 №13  23
        ExcelC.pCellVal(i) = Convert.ToString("販売事業者名") : i += 1         ' 2014/12/11 H.Hosoda add 監視改善2014 №13  24
        ExcelC.pCellVal(i) = Convert.ToString("販売所コード") : i += 1         ' 2017/02/17 W.GANEKO add 監視改善2016 №7   25
        ExcelC.pCellVal(i) = Convert.ToString("ＪＡ支所コード") : i += 1                                                   '26
        ExcelC.pCellVal(i) = Convert.ToString("ＪＡ支所名") : i += 1                                                       '27
        ExcelC.pCellVal(i) = Convert.ToString("お客様コード") : i += 1                                                     '28
        ExcelC.pCellVal(i) = Convert.ToString("お客様名") : i += 1                                                         '29
        ...
        ExcelC.pCellVal(i) = Convert.ToString("監視対応内容") : i += 1                                                     '43
        ExcelC.pCellVal(i) = Convert.ToString("メモ欄") : i += 1         '2014/12/09 H.Hosoda add 監視改善2014 №13         44
        ExcelC.pCellVal(i) = Convert.ToString("監視備考") : i += 1      ' 2016/2/1 H.Mori add 監視改善2015 №10             45
        ExcelC.pCellVal(i) = Convert.ToString("原因器具") : i += 1                                                         '46
        ExcelC.pCellVal(i) = Convert.ToString("作動原因") : i += 1                                                         '47
        ExcelC.pCellVal(i) = Convert.ToString("NCU接続(種別)") : i += 1 ' 2017/02/17 W.GANEKO add 監視改善2016 №7          48
        ExcelC.pCellVal(i) = Convert.ToString("接続区分") : i += 1      ' 2017/02/17 W.GANEKO add 監視改善2016 №7          49
        ExcelC.pCellVal(i) = Convert.ToString("対応完了日") : i += 1    ' 2017/02/17 W.GANEKO add 監視改善2016 №7          50
        ExcelC.pCellVal(i) = Convert.ToString("対応完了時刻") : i += 1  ' 2017/02/17 W.GANEKO add 監視改善2016 №7          51
        ExcelC.pCellVal(i) = Convert.ToString("出動依頼日") : i += 1                                                       '52
        ExcelC.pCellVal(i) = Convert.ToString("出動依頼時刻") : i += 1                                                     '53
        ExcelC.pCellVal(i) = Convert.ToString("出動会社名") : i += 1                                                       '54
        ExcelC.pCellVal(i) = Convert.ToString("出動受付者") : i += 1 ' 2010/03/24 T.Watabe add                              55
        ExcelC.pCellVal(i) = Convert.ToString("出動対応者") : i += 1 ' 2010/03/24 T.Watabe add                              56
        ExcelC.pCellVal(i) = Convert.ToString("出動日") : i += 1                                                           '57
        ExcelC.pCellVal(i) = Convert.ToString("出動時刻") : i += 1                                                         '58
        ExcelC.pCellVal(i) = Convert.ToString("到着日") : i += 1                                                           '59
        ExcelC.pCellVal(i) = Convert.ToString("到着時刻") : i += 1                                                         '60
        ExcelC.pCellVal(i) = Convert.ToString("出動対応内容") : i += 1                                                     '61
        ExcelC.pCellVal(i) = Convert.ToString("復帰操作") : i += 1                                                         '62
        ExcelC.pCellVal(i) = Convert.ToString("処理完了日") : i += 1                                                       '63
        ExcelC.pCellVal(i) = Convert.ToString("処理完了時刻") : i += 1                                                     '64
        ExcelC.pCellVal(i) = Convert.ToString("適用法令区分") : i += 1                                                     '65
        ExcelC.pCellVal(i) = Convert.ToString("供給形態区分") : i += 1                                                     '66
        ExcelC.pCellVal(i) = Convert.ToString("用途区分") : i += 1                                                         '67
        ExcelC.mWriteLine("")       '行をファイルに書き込む                                                                
        ...
        For iCnt = 0 To ds.Tables(0).Rows.Count - 1
            ...
            ExcelC.pCellStyle(25) = excel_h13px & excel_w50px
            ExcelC.pCellStyle(26) = excel_h13px & excel_w60px
            ExcelC.pCellStyle(27) = excel_h13px & excel_w100px
            ...
            ExcelC.pCellStyle(32) = excel_h13px & excel_w100px
            ...
            ExcelC.pCellStyle(37) = excel_h13px & excel_w70px
            ExcelC.pCellStyle(38) = excel_h13px & excel_w70px
            ExcelC.pCellStyle(39) = excel_h13px & excel_w100px
            ExcelC.pCellStyle(40) = excel_h13px & excel_w70px
            ExcelC.pCellStyle(41) = excel_h13px & excel_w70px
            ExcelC.pCellStyle(42) = excel_h13px & excel_w70px
            ExcelC.pCellStyle(43) = excel_h13px & excel_w150px
            ExcelC.pCellStyle(44) = excel_h13px & excel_w100px
            ExcelC.pCellStyle(45) = excel_h13px & excel_w70px
            ExcelC.pCellStyle(46) = excel_h13px & excel_w70px
            ExcelC.pCellStyle(47) = excel_h13px & excel_w100px
            ExcelC.pCellStyle(48) = excel_h13px & excel_w30px
            ExcelC.pCellStyle(49) = excel_h13px & excel_w50px
            ExcelC.pCellStyle(50) = excel_h13px & excel_w60px
            ExcelC.pCellStyle(51) = excel_h13px & excel_w60px
            ExcelC.pCellStyle(52) = excel_h13px & excel_w60px
            ExcelC.pCellStyle(53) = excel_h13px & excel_w60px
            ExcelC.pCellStyle(54) = excel_h13px & excel_w100px

            ExcelC.pCellStyle(55) = excel_h13px & excel_w100px
            ExcelC.pCellStyle(56) = excel_h13px & excel_w100px
            ExcelC.pCellStyle(57) = excel_h13px & excel_w60px
            ExcelC.pCellStyle(58) = excel_h13px & excel_w60px
            ExcelC.pCellStyle(59) = excel_h13px & excel_w60px
            ExcelC.pCellStyle(60) = excel_h13px & excel_w60px
            ExcelC.pCellStyle(61) = excel_h13px & excel_w100px
            ExcelC.pCellStyle(62) = excel_h13px & excel_w100px
            ExcelC.pCellStyle(63) = excel_h13px & excel_w60px
            ExcelC.pCellStyle(64) = excel_h13px & excel_w60px
            ExcelC.pCellStyle(65) = excel_h13px & excel_w70px
            ExcelC.pCellStyle(66) = excel_h13px & excel_w70px
            ExcelC.pCellStyle(67) = excel_h13px & excel_w70px
            ExcelC.pCellStyle(68) = excel_h13px & excel_w10px
            i = 1
            ExcelC.pCellVal(i) = Convert.ToString(dr.Item("FAXKBN")) : i += 1 ' FAX不要 1:不要/2:必要
            ExcelC.pCellVal(i) = Convert.ToString(dr.Item("FAXKURAKBN")) : i += 1 ' ＦＡＸ不要(ｸﾗｲｱﾝﾄ) 1:不要/2:必要
            ExcelC.pCellVal(i) = Convert.ToString(dr.Item("FAXRUISEKIKBN")) : i += 1 ' 報告不要(累積) 1:不要/2:必要 2016/02/26 H.Mori add 監視改善2015 №10
    ...
    Function excelOut2(ByVal OUTLIST As String, ByVal ds As DataSet, ByVal dr As DataRow, ByVal ExcelC As Common.CExcel) As Common.CExcel
        ...
        For iCnt = 0 To ds.Tables(0).Rows.Count - 1
            ...
            ExcelC.pCellVal(i) = Convert.ToString(dr.Item("TEL_MEMO1")) & Convert.ToString(dr.Item("TEL_MEMO2")) & Convert.ToString(dr.Item("FUK_MEMO")) : i += 1 '38 監視対応内容
    ...
    Public Function fncMakeSelect(ByVal pstrKANSCD As String,
                                  ...
                                  ByVal pstrHOKBN As String,
                                  ByVal pstrOUTLIST As String,
                                  ByVal pstrTFKINM As String) As String
