...
' 2011/05/31 T.Watabe 旧自動FAXのレイアウトも新自動FAXと同様にして１枚からはみ出ないように修正
' 2011/10/27 T.Watabe 帳票F列の幅を狭くしてG列を広くする事により、連絡電話番号がデータにより隠れる現象を改善
'                     空白ページも改善されるかもしれない。　　　　　　　　　　　　　　
' 2012/08/21 T.Watabe FAX番号からハイフンを抜いて対象検索
...
#End Region
    ...
    <WebMethod()> Public Function mExcel( _
        ...
        Try
            ...
            strSQL.Append("        DECODE(JAS.AUTO_KUBUN, 1, REPLACE(JAS.AUTO_FAX, '-' ), '') AS AUTO_FAX, ")
    ...
    Private Function mExcelOut( _
        ...
        Try
            ...
            If pstrAUTO = strFAXKBN Then
                'ＦＡＸ送信の場合
                'strSQL.Append("  AND JAS.AUTO_FAX = :AUTO_FAX ") '2012/08/21 T.Watabe Edit FAX番号からハイフンを抜いて対象検索
                strSQL.Append("  AND REPLACE(JAS.AUTO_FAX, '-') = :AUTO_FAX ")
            Else
                'メール送信の場合
            ...
            'ExcelC.pCellStyle(6) = "width:115px;border-style:none" ' 2011/10/27 T.Watabe edit
            'ExcelC.pCellStyle(7) = "width:72px;border-style:none" ' 2011/10/27 T.Watabe edit
            ...
            ExcelC.pCellStyle(10) = "width:3px;border-style:none" ' 2011/05/31 T.Watabe edit
            ExcelC.pCellStyle(11) = "width:3px;border-style:none" ' 2011/05/31 T.Watabe add
            ExcelC.pCellStyle(12) = "width:3px;border-style:none" ' 2011/05/31 T.Watabe add
            ExcelC.pCellVal(1) = ""
            ExcelC.pCellVal(2) = ""
            ExcelC.pCellVal(3) = ""
            ExcelC.pCellVal(4) = ""
            ...
            ExcelC.pCellVal(9) = ""
            ExcelC.pCellVal(10) = ""
            ExcelC.pCellVal(11) = "" ' 2011/05/31 T.Watabe add
            ExcelC.pCellVal(12) = "" ' 2011/05/31 T.Watabe add
            ...
            For Each dr In ds.Tables(0).Rows
                ...
                If pstrAUTO = "1" Then
                    'ExcelC.pCellVal(1, "colspan=6") = "送信先FAX番号：" & Convert.ToString(dr.Item("AUTO_FAX")) ' 2011/05/31 T.Watabe edit
