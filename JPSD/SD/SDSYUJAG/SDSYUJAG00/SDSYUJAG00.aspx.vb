...
#End Region
    ...
    Private Function fncDataSelect() As String
        ...
        Try
            ...
            strSQL.Append(" ,D20.TEL_MEMO4")            '2020/11/01 T.Ono add 2020監視改善
            strSQL.Append(" ,D20.TEL_MEMO5")            '2020/11/01 T.Ono add 2020監視改善
            strSQL.Append(" ,D20.TEL_MEMO6")            '2020/11/01 T.Ono add 2020監視改善
    ...
    Private Sub fncDataSet(ByVal pdbData As DataSet)
        ...
        Try
            ...
            Else
                ...
                'txtTEL_MEMO.Value = Convert.ToString(pdbData.Tables(0).Rows(0).Item("TEL_MEMO1")) & vbCrLf &
                '                    Convert.ToString(pdbData.Tables(0).Rows(0).Item("TEL_MEMO2")) & vbCrLf &
                '                    Convert.ToString(pdbData.Tables(0).Rows(0).Item("FUK_MEMO"))
                txtTEL_MEMO.Value = Convert.ToString(pdbData.Tables(0).Rows(0).Item("TEL_MEMO1")) & vbCrLf &
                                    Convert.ToString(pdbData.Tables(0).Rows(0).Item("TEL_MEMO2")) & vbCrLf &
                                    Convert.ToString(pdbData.Tables(0).Rows(0).Item("FUK_MEMO")) & vbCrLf &
                                    Convert.ToString(pdbData.Tables(0).Rows(0).Item("TEL_MEMO4")) & vbCrLf &
                                    Convert.ToString(pdbData.Tables(0).Rows(0).Item("TEL_MEMO5")) & vbCrLf &
                                    Convert.ToString(pdbData.Tables(0).Rows(0).Item("TEL_MEMO6"))
                '2020/11/01 T.Ono mod 2020監視改善 End 
                ' 2013/10/24 T.Ono 監視改善2013№1 End
                'お客様記事
                'txtGENIN_KIJI.Text = Convert.ToString(pdbData.Tables(0).Rows(0).Item("GENIN_KIJI"))    '2021/02/09 T.Ono mod 2020監視改善
