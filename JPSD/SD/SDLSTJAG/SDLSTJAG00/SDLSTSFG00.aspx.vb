...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strScript.Append(cscript1.mWriteScript( _
             MyBase.MapPath("../../../SD/SDLSTJAG/SDLSTJAG00/") & "SDLSTSFG00.js"))
        '//一覧スクリプト
        ...
        'スクロール位置
        hdnScrollTop.Value = SDLSTJAG00_C.pScrollTop                '2013/12/10 T.Ono add 監視改善2013
        ...
        Try
            ...
            If SDLSTJAG00_C.pSelectClick = "1" Or SDLSTJAG00_C.pSelectClick = "2" Then
            ...
            Else
                ...
                For intRow = 0 To dbData.Tables(0).Rows.Count - 1
                    ...
                    dbData.Tables(0).Rows(intRow).Item("TMSKB") = _
    ...
    Private Sub mMakeSQL(ByVal strSQL As StringBuilder, ByVal SqlParamC As CSQLParam, ByVal intkbn As Integer, ByVal intCount As Integer)
        ...
        '2005/09/28 NEC UPDATE START
        'チューニング。なぜかHATYMD,HATTIMEのインデックスを使用してしまうため、工夫
        'strSQL.Append("SELECT ")
        strSQL.Append("SELECT * FROM (SELECT ")
        '2005/09/28 NEC UPDATE END
        If intkbn = 0 Then
            If intCount > 0 Then
                ...
                'strSQL.Append("	TAI.TMSKB AS TMSKBCD,") ' 2008/10/15 T.Watabe edit
                strSQL.Append("	TAI.SDSKBN AS TMSKBCD,")
        ...
        '処理区分（1:未処理　または　3:出動対応中　を対象） ' 2008/10/15 T.Watabe edit
        'strSQL.Append(" AND (TAI.TMSKB = '1' OR TAI.TMSKB = '3') ")
        ...
        '出動会社処理区分（1:未処理　または　3:出動対応中　を対象）
        strSQL.Append(" AND (TAI.SDSKBN = '1' OR TAI.SDSKBN = '3') ")
        ...
        If intkbn = 0 Then
            ...
            'strSQL.Append("  AND TAI.TMSKB = P10.CD(+) ") ' 2008/10/15 T.Watabe edit
            strSQL.Append("  AND TAI.SDSKBN = P10.CD(+) ")
            '2005/09/28 NEC UPDATE START
            'チューニング。なぜかHATYMD,HATTIMEのインデックスを使用してしまうため、工夫
            ...
            strSQL.Append(") ORDER BY HATYMD DESC,HATTIME DESC,SYONO DESC")
