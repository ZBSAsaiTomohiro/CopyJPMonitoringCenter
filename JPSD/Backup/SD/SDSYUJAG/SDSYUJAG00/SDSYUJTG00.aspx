						...
						<div style="color:black; height:560px; width:100%; overflow:auto;">
							...
							<table id="Table3" cellspacing="0" cellpadding="3">
								<tr>
                                    ...
                                    <td>連絡先01</td>
									<td colspan="4"><asp:textbox id="txtTANNM1" tabindex="-1" runat="server" readonly="True" width="400px" borderstyle="Solid" borderwidth="1px" cssclass="c-rNM"></asp:textbox></td>
								</tr>
                                <tr style="BORDER-RIGHT: black thin solid; BORDER-TOP: black thin solid; BORDER-LEFT: black thin solid; BORDER-BOTTOM: black thin solid">
									...
									<td nowrap align="left" width="140">
										<asp:textbox id="txtFAX1" tabindex="-1" runat="server" readonly="True" width="112px" borderstyle="Solid" borderwidth="1px" cssclass="c-rNM"></asp:textbox></td>
								</tr>
								<tr>
									<%--<td>連絡先記事</td> 2016/02/05 H.Mori mod 連絡先記事 → 記事--%>
                                    <td>記事</td>
									<td colspan="4"><asp:textbox id="txtBIKO1" tabindex="-1" runat="server" readonly="True" width="400px" borderstyle="Solid" borderwidth="1px" cssclass="c-rNM"></asp:textbox></td>
								</tr>
							</table>
							<hr style="COLOR: black" width="98%">
							<table id="Table3" cellspacing="0" cellpadding="3">
								<tr>
                                    ...
                                    <td>連絡先02</td>
									<td colspan="4"><asp:textbox id="txtTANNM2" tabindex="-1" runat="server" readonly="True" width="400px" borderstyle="Solid" borderwidth="1px" cssclass="c-rNM"></asp:textbox></td>
								</tr>
								<tr>
									<%--<td nowrap width="80">電話番号</td> 2016/02/05 H.Mori mod 電話番号 → TEL--%>
                                    <td nowrap width="80">TEL</td>
                                    ...
                                    <td nowrap align="right" width="50">FAX&nbsp;</td>
									<td nowrap align="left" width="140">
										<asp:textbox id="txtFAX2" tabindex="-1" runat="server" readonly="True" width="112px" borderstyle="Solid" borderwidth="1px" cssclass="c-rNM"></asp:textbox></td>
								</tr>
								<tr>
									<%--<td>連絡先記事</td> 2016/02/05 H.Mori mod 連絡先記事 → 記事--%>
                                    <td>記事</td>
									<td colspan="4"><asp:textbox id="txtBIKO2" tabindex="-1" runat="server" readonly="True" width="400px" borderstyle="Solid" borderwidth="1px" cssclass="c-rNM"></asp:textbox></td>
								</tr>
							</table>
							<hr style="COLOR: black" width="98%">
							<table id="Table3" cellspacing="0" cellpadding="3">
								<tr>
                                    ...
                                    <td>連絡先03</td>
									<td colspan="4"><asp:textbox id="txtTANNM3" tabindex="-1" runat="server" readonly="True" width="400px" borderstyle="Solid" borderwidth="1px" cssclass="c-rNM"></asp:textbox></td>
								</tr>
								<tr>
									<%--<td nowrap width="80">電話番号</td> 2016/02/05 H.Mori mod 電話番号 → TEL--%>
                                    <td nowrap width="80">TEL</td>
							...
							<table id="Table3" cellspacing="0" cellpadding="3">
								<tr>
                                    ...
                                    <td>連絡先04</td>
									<td colspan="4"><asp:textbox id="txtTANNM4" tabindex="-1" runat="server" readonly="True" width="400px" borderstyle="Solid" borderwidth="1px" cssclass="c-rNM"></asp:textbox></td>
								</tr>
                                <tr>
									<%--<td nowrap width="80">電話番号</td> 2016/02/05 H.Mori mod 電話番号 → TEL--%>
                                    <td nowrap width="80">TEL</td>
								...
								<tr>
									<%--<td>連絡先記事</td> 2016/02/05 H.Mori mod 連絡先記事 → 記事--%>
                                    <td>記事</td>
									<td colspan="4"><asp:textbox id="txtBIKO4" tabindex="-1" runat="server" readonly="True" width="400px" borderstyle="Solid" borderwidth="1px" cssclass="c-rNM"></asp:textbox></td>
								</tr>
							</table>
							...
							<table id="Table3" cellspacing="0" cellpadding="3">
								<tr>
                                    ...
                                    <td>連絡先5</td>
									<td colspan="4"><asp:textbox id="txtTANNM5" tabindex="-1" runat="server" readonly="True" width="400px" borderstyle="Solid" borderwidth="1px" cssclass="c-rNM"></asp:textbox></td>
								</tr>
                                <tr>
									<%--<td nowrap width="80">電話番号</td> 2016/02/05 H.Mori mod 電話番号 → TEL--%>
                                    <td nowrap width="80">TEL</td>
								...
								<tr>
									<%--<td>連絡先記事</td> 2016/02/05 H.Mori mod 連絡先記事 → 記事--%>
                                    <td>記事</td>
									<td colspan="4"><asp:textbox id="txtBIKO5" tabindex="-1" runat="server" readonly="True" width="400px" borderstyle="Solid" borderwidth="1px" cssclass="c-rNM"></asp:textbox></td>
								</tr>
							</table>
							<hr style="COLOR: black" width="95%">
							<table id="Table3" cellspacing="0" cellpadding="3">
								<tr>
                                    ...
                                    <td>連絡先6</td>
									<td colspan="4"><asp:textbox id="txtTANNM6" tabindex="-1" runat="server" readonly="True" width="400px" borderstyle="Solid" borderwidth="1px" cssclass="c-rNM"></asp:textbox></td>
								</tr>
                                <tr>
									<%--<td nowrap width="80">電話番号</td> 2016/02/05 H.Mori mod 電話番号 → TEL--%>
                                    <td nowrap width="80">TEL</td>
								...
								<tr>
									<%--<td>連絡先記事</td> 2016/02/05 H.Mori mod 連絡先記事 → 記事--%>
                                    <td>記事</td>
									<td colspan="4"><asp:textbox id="txtBIKO6" tabindex="-1" runat="server" readonly="True" width="400px" borderstyle="Solid" borderwidth="1px" cssclass="c-rNM"></asp:textbox></td>
								</tr>
							</table>
							<hr style="COLOR: black" width="95%">
							<table id="Table3" cellspacing="0" cellpadding="3">
								<tr>
                                    ...
                                    <td>連絡先7</td>
									<td colspan="4"><asp:textbox id="txtTANNM7" tabindex="-1" runat="server" readonly="True" width="400px" borderstyle="Solid" borderwidth="1px" cssclass="c-rNM"></asp:textbox></td>
								</tr>
                                <tr>
									<%--<td nowrap width="80">電話番号</td> 2016/02/05 H.Mori mod 電話番号 → TEL--%>
                                    <td nowrap width="80">TEL</td>
							...
							<table id="Table3" cellspacing="0" cellpadding="3">
								<tr>
                                    ...
                                    <td>連絡先8</td>
									<td colspan="4"><asp:textbox id="txtTANNM8" tabindex="-1" runat="server" readonly="True" width="400px" borderstyle="Solid" borderwidth="1px" cssclass="c-rNM"></asp:textbox></td>
								</tr>
                                <tr>
									<%--<td nowrap width="80">電話番号</td> 2016/02/05 H.Mori mod 電話番号 → TEL--%>
                                    <td nowrap width="80">TEL</td>
								...
								<tr>
									<%--<td>連絡先記事</td> 2016/02/05 H.Mori mod 連絡先記事 → 記事--%>
                                    <td>記事</td>
									<td colspan="4"><asp:textbox id="txtBIKO8" tabindex="-1" runat="server" readonly="True" width="400px" borderstyle="Solid" borderwidth="1px" cssclass="c-rNM"></asp:textbox></td>
								</tr>
							</table>
							<hr style="COLOR: black" width="95%">
							<table id="Table3" cellspacing="0" cellpadding="3">
								<tr>
                                    ...
                                    <td>連絡先9</td>
									<td colspan="4"><asp:textbox id="txtTANNM9" tabindex="-1" runat="server" readonly="True" width="400px" borderstyle="Solid" borderwidth="1px" cssclass="c-rNM"></asp:textbox></td>
								</tr>
                                <tr>
									<%--<td nowrap width="80">電話番号</td> 2016/02/05 H.Mori mod 電話番号 → TEL--%>
                                    <td nowrap width="80">TEL</td>
                                    ...
                                    <td nowrap align="right" width="50">FAX&nbsp;</td>
									<td nowrap align="left" width="140">
										<asp:textbox id="txtFAX9" tabindex="-1" runat="server" readonly="True" width="112px" borderstyle="Solid" borderwidth="1px" cssclass="c-rNM"></asp:textbox></td>
								</tr>
								<tr>
									<%--<td>連絡先記事</td> 2016/02/05 H.Mori mod 連絡先記事 → 記事--%>
                                    <td>記事</td>
									<td colspan="4"><asp:textbox id="txtBIKO9" tabindex="-1" runat="server" readonly="True" width="400px" borderstyle="Solid" borderwidth="1px" cssclass="c-rNM"></asp:textbox></td>
								</tr>
							</table>
							<hr style="COLOR: black" width="95%">
							<table id="Table3" cellspacing="0" cellpadding="3">
								<tr>
                                    ...
                                    <td>連絡先10</td>
									<td colspan="4"><asp:textbox id="txtTANNM10" tabindex="-1" runat="server" readonly="True" width="400px" borderstyle="Solid" borderwidth="1px" cssclass="c-rNM"></asp:textbox></td>
								</tr>
                                <tr>
									<%--<td nowrap width="80">電話番号</td> 2016/02/05 H.Mori mod 電話番号 → TEL--%>
                                    <td nowrap width="80">TEL</td>
                                    ...
                                    <td nowrap align="right" width="50">FAX&nbsp;</td>
									<td nowrap align="left" width="140">
										<asp:textbox id="txtFAX10" tabindex="-1" runat="server" readonly="True" width="112px" borderstyle="Solid" borderwidth="1px" cssclass="c-rNM"></asp:textbox></td>
								</tr>
								<tr>
									<%--<td>連絡先記事</td> 2016/02/05 H.Mori mod 連絡先記事 → 記事--%>
                                    <td>記事</td>
									<td colspan="4"><asp:textbox id="txtBIKO10" tabindex="-1" runat="server" readonly="True" width="400px" borderstyle="Solid" borderwidth="1px" cssclass="c-rNM"></asp:textbox></td>
								</tr>
							</table>
							<!-- ▲ 2008/11/04 T.Watabe add -->
