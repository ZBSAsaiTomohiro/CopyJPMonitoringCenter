...
'
'このソース コードは Microsoft.VSDesigner、バージョン 4.0.30319.239 によって自動生成されました。
'
Namespace SDSYUJAG00CSQL
    ...
    Partial Public Class CSQL
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.JPSD.SDSYUJAG00.My.MySettings.Default.SDSYUJAG00_SDSYUJAG00CSQL_CSQL
