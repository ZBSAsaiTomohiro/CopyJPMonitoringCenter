...
%>
			...
			<%'**********  電話連絡２  ************%>
			<TABLE style="LEFT: 10px; POSITION: absolute; TOP: 310px" cellSpacing="0" cellPadding="0">
...
<%--                2013/10/24 T.Ono 監視改善2013№1 
			...
			<%'**********  対応内容１  ************%>
			<SPAN style="Z-INDEX: 4; LEFT: 40px; POSITION: absolute; TOP: 425px">
            ...
            <TABLE style="Z-INDEX: 4; LEFT: 40px; POSITION: absolute; TOP: 541px" cellSpacing="0" cellPadding="0">
				<TR>
                <%-- 2013/08/26 T.Ono mod 監視改善2013№1
            ...
            <TABLE class="W" style="Z-INDEX: 4; LEFT: 450px; POSITION: absolute; TOP: 541px" cellSpacing="0"
				cellPadding="0">
				<TR>
			...
			<%'**********  点検２  ************%>
			<TABLE style="Z-INDEX: 4; LEFT: 755px; POSITION: absolute; TOP: 538px" cellSpacing="0"
				cellPadding="0">
				<TR>
			...
			<%'**********  最後の備考  ************%>
			<TABLE style="Z-INDEX: 4; LEFT: 10px; POSITION: absolute; TOP: 630px" cellSpacing="0" cellPadding="0">
				<TR>
			...
			<TABLE style="Z-INDEX: 4; LEFT: 70px; POSITION: absolute; TOP: 625px" cellSpacing="0" cellPadding="0">
				<%-- 2013/08/26 T.Ono mod 監視改善2013№1 --%>
<%--            <TR>
			...
			<TABLE style="BORDER-RIGHT: black 1px solid; BORDER-TOP: black 1px solid; Z-INDEX: 1; LEFT: 5px; BORDER-LEFT: black 1px solid; WIDTH: 990px; BORDER-BOTTOM: black 1px solid; POSITION: absolute; TOP: 402px; HEIGHT: 290px; BACKGROUND-COLOR: #dbffff"
